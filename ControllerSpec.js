...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
        // TODO: write test
		// on teste si on affiche model et view
        ...
        console.log("Test Model and view");
	});
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
            // TODO: write test
			//test la View lors de l'affichage des todo de l'onglet active
			var todo = {title: 'my todo'};
			setUpModel([todo]);
		...
		it('should show completed entries', function () {
            // TODO: write test
			//test la View lors de l'affichage des todo de l'onglet completed 
			var todo = {title: 'my todo'};
			setUpModel([todo]);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
            // TODO: write test
			//teste de la view  "All" si elle est surligné quand on a l'onglet par défaut
		...
		it('should update the view', function () {
            // TODO: write test
			// teste de la view "Active" voir si elle est surligné quand on change pour l'onglet active
			var todo = {id: 42, title: 'my todo', completed: true};
            setUpModel([todo]);
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
            // TODO: write test
			// on teste le modèle si on ajoute un todo
			setUpModel([]);
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
            // TODO: write test
			// teste le modele quand on supprime un todo
			var todo = {id: 42, title: 'my todo', completed: true};
			setUpModel([todo]);
